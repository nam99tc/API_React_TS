    ...
    public class NavigationHandler : INavigationHandler
    {
        ...
        public ResponseData Create(NavigationModel model)
        {
            try
            {
                ...
                {
                    return new ResponseDataError(Code.BadRequest, Constant.Code_already);
                }
        ...
        public ResponseData Get()
        {
            try
            {
                ...
                return new ResponseDataObject<List<NavigationModel>>
                    (result.Where(p => string.IsNullOrEmpty(p.ParentId.ToString())).ToList(), Code.Success, Constant.Success);
            }
            catch (Exception exception)
            {
                Log.Error(exception, exception.Message);
        ...
        public ResponseData GetById(Guid id)
        {
            try
            {
                ...
                return new ResponseDataObject<NavigationModel>(result, Code.Success, Constant.Success);
            }
            catch (Exception exception)
            {
                Log.Error(exception, exception.Message);
